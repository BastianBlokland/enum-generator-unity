...
1. Add a reference to this repository to your package dependencies (`Packages/manifest.json`)
    ...
    ```
    "dependencies": {
        "com.bastianblokland.enumgenerator": "https://github.com/BastianBlokland/enum-generator-unity.git#v1.1",
        ...
    }
    ```
2. Add the NuGet dependency to your project.

    If your project uses a NuGet package manager you can simply add a dependency to [**EnumGenerator.Core**](https://www.nuget.org/packages/EnumGenerator.Core/) version `3.1.*`.
